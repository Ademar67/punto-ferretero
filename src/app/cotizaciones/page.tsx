    ...
    <div className="p-6 lg:p-10 space-y-8 bg-[#f8f9fa] min-h-full">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium">
              Presupuestos con vigencia automática de 7 días.
            </p>
          </div>
        </div>
        ...
        <Button
          asChild
          size="lg"
          className="h-14 bg-teal-600 hover:bg-teal-700 text-white font-black uppercase tracking-tighter rounded-xl shadow-lg"
        >
        ...
        <Table>
          ...
          <TableBody>
            {filteredQuotes.map((quote) => (
              <TableRow
                key={quote.id}
                className="hover:bg-teal-50/50 border-border/50 transition-colors"
              >
                ...
                <TableCell className="text-xs">
                  {quote.date?.seconds
                    ? format(new Date(quote.date.seconds * 1000), "dd MMM, yy", {
                        locale: es,
                      })
                    : "---"}
                </TableCell>
                ...
                <TableCell className="text-right">
                  <div className="flex justify-end gap-1">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-9 w-9 hover:bg-teal-600 hover:text-white rounded-lg"
        ...
        <DialogContent className="max-w-2xl border-none p-0 bg-transparent shadow-none">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl space-y-6">
            ...
            <div className="flex gap-4 pt-4 border-t">
              <Button
                variant="outline"
                className="flex-1 h-14 border-2 border-black font-black uppercase rounded-xl"
              ...
              <Button
                className="bg-black text-white font-black uppercase h-14 px-8 rounded-xl"
